(() => {
  ...
  const productCatalog = {
    ...
    'bone-age-analyser': {
      ...
      images: ['assets/products/visual-bone-age-device-v3.webp'],
      heroFit: 'contain',
      storyImage: 'assets/products/visual-bone-age-positioning-v1.webp',
      storyFit: 'cover',
    ...
    'bone-density-analyser': {
      ...
      images: ['assets/products/visual-bone-density-device-v2.webp'],
      heroFit: 'contain',
      storyImage: 'assets/products/visual-bone-density-positioning-v1.webp',
      storyFit: 'cover',
